...
text = "<div class='card'>"
          ...
          +"<div>"
            ...
            +"<i style='width: 7%; height: 7%; color:#858b8f;'id='mail' class='far fa-envelope w3-xxlarge'></i>"
            +"<i style='width: 7%; height: 7%; color:#858b8f;'id='aniversario' class='far fa-calendar-alt w3-xxlarge'></i>"
            +"<i style='width: 7%; height: 7%; color:#858b8f;'id='endereco' class='fas fa-map-marked-alt w3-xxlarge'></i>"
            +"<i style='width: 7%; height: 7%; color:#858b8f;'id='phone' class='fas fa-phone w3-xxlarge'></i>"
            +"<i style='width: 7%; height: 7%; color:#858b8f;'id='situacao' class='fas fa-key w3-xxlarge'></i>"
          +"</div>"
